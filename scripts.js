...
// creates table of key codes description for html-page
function createTable() {
  let tableBodyRef = document.querySelector('.table__body');
...
function keyEvent(event) {
  ...
  //   main center section
  document.querySelector('.keycode--display').innerHTML = event.keyCode;
  // cards
  document.querySelector('.item-key .main-description').innerHTML = event.key;
...
function toggleTable() {
  ...
  let hidden = table.classList.contains('hide');
  document.querySelector('#button--table').textContent = hidden
    ? 'Table'
    : 'Back';
  ...
  if (hidden) {
    ...
    bodyRef.removeEventListener('keydown', keyEvent);
  }
}
// -------table show/hide END---------
...
let themeBtnRef = document.querySelector('#button--theme');
...
function toggleTheme() {
  ...
  if (theme === DARK_THEME) {
    ...
    themeBtnRef.innerHTML = 'Dark theme';
  } else {
    theme = DARK_THEME;
    html.classList.add(theme);
    html.classList.remove('theme--light');
    themeBtnRef.innerHTML = 'Light theme';
  }
}
// -------theme change END-----------
